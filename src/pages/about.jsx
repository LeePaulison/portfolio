export const About = () => {
  return (
    <div className='max-w-[720px] mx-auto grow'>
      ...
      <p className='mb-4'>
        And none of that helps you, or maybe it does. Let us speak candidly. One of the parts of me not mentioned in the
        above is that I am also a Quadriplegic. Without a medical explanation, let us keep it short to the following. I
        have limited mobility in my hands and cannot feel anything from mid-chest down. Mentioning this puts me at a
        disadvantage or so I have been told. But there is another part of me not mentioned above, I am honest to a
        fault. My biggest pet peeve is lying. Do not lie to me. Do not lie to clients in front of me. While I will hold
        my tongue, you have now lost all my respect and trust. And while respect is freely given, trust is earned. Lying
        has never brought about a positive outcome.
      </p>
      <p className='mb-4'>
      ...
      <p className='mb-4'>
        ...
        media player is written with performance and appearance in mind. Keeping the design simple, yet familiar while
        adding other features such as Focus Points and Knowledge Checks. Focus Points are timestamps chosen for content
        that should be noted by the learner. Knowledge Checks are like Focus Points in that they rely on timestamps;
        they differ in that they ask the learner a question regarding the content being presented.
      </p>
    </div>
  );
};
